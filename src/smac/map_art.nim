...
proc endzoneTints(gameMap: SmacMap): seq[EndzoneTint] =
...
proc loadMapLayers*(gameMap: SmacMap, withEndzoneGlow = true):
...
proc coldEndzoneMapRgba*(gameMap: SmacMap): seq[uint8] =
