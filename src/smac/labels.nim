...
const
  ...
  LabelPrefixCogGun* = "cog gun "
    ## The held micro marker, `cog gun <color>` (board stream only).
  ...
  LabelPrefixBarrierUp* = "barrier up "
    ...
    ## way, BarrierRadius=24px out), and `hp <n>` the micro hits it can
  ...
  LabelSideLeft* = "left"
  LabelWeaponGun* = "gun"
    ## Default micro marker; see `labelWeapon` / `labelIdentity`.
